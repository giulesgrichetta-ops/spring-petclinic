...
class PetClinicRuntimeHintsTests {
	...
	@Test
	void registerHintsRegistersResourcePatterns() {
		RuntimeHints hints = new RuntimeHints();
		new PetClinicRuntimeHints().registerHints(hints, getClass().getClassLoader());

		assertThat(RuntimeHintsPredicates.resource().forResource("db/data.sql").test(hints)).isTrue();
	...
	@Test
	void registerHintsRegistersSerializationTypes() {
		RuntimeHints hints = new RuntimeHints();
		new PetClinicRuntimeHints().registerHints(hints, getClass().getClassLoader());
